    ...
    <div className="min-h-screen bg-black relative text-white p-8 flex flex-col items-center justify-center *:select-none">
      <div className="absolute right-5 bottom-5 w-[240px] h-[240px]">
        ...
        <div className="absolute inset-0 left-7 -top-5 flex items-center justify-center flex-col">
          ...
          <div className="absolute top-[calc(52%+60px)] flex flex-row space-x-5 justify-center left-1/2 -translate-x-1/2 text-white text-sm">
            <svg
              width="11"
              height="11"
              viewBox="0 0 11 11"
            ...
            >
              <path
                d="M10.3701 1.88765C10.3543 1.77779 10.2779 1.68623 10.1727 1.65105C10.0679 1.61558 9.9515 1.64332 9.87281 1.72171L9.45854 2.13629C9.23709 2.35773 8.85113 2.35773 8.62969 2.13629C8.40055 1.90714 8.40066 1.53671 8.62969 1.30773L9.04397 0.893453C9.12236 0.815055 9.14983 0.698902 9.11463 0.593609C9.07943 0.488316 8.98789 0.41193 8.87803 0.396207C8.33129 0.318961 7.77797 0.502633 7.38686 0.89316C6.94455 1.33576 6.77002 1.98636 6.93166 2.59146L2.60002 6.92295L2.59973 6.92265C1.99692 6.76273 1.3426 6.93724 0.901721 7.37812C0.513186 7.76666 0.327229 8.32427 0.404475 8.86957C0.420217 8.97943 0.496604 9.07099 0.601878 9.10617C0.706311 9.14136 0.82303 9.1139 0.901721 9.0355L1.316 8.62093C1.53744 8.39949 1.9234 8.39949 2.14485 8.62093C2.37399 8.85004 2.37387 9.22047 2.14485 9.44949L1.73057 9.86377C1.65217 9.94216 1.62471 10.0583 1.6599 10.1636C1.6951 10.2689 1.78664 10.3453 1.89651 10.361C2.44182 10.4386 2.99053 10.2608 3.38768 9.86406C3.82998 9.42146 4.00451 8.77086 3.84287 8.16576L8.17451 3.83427L8.17481 3.83457C8.78076 3.99507 9.43193 3.81998 9.87281 3.3791C10.2613 2.99056 10.4473 2.43297 10.3701 1.88765Z"
                fill="#FACC15"
              />
              <path
                d="M8.62936 6.86317C8.49061 6.86317 8.34784 6.88405 8.18018 6.9284L7.04468 5.79303L5.80145 7.03612L6.93678 8.17153C6.89243 8.33946 6.87155 8.48223 6.87155 8.62098C6.87155 9.5903 7.66005 10.3788 8.62936 10.3788C9.59868 10.3788 10.3872 9.5903 10.3872 8.62098C10.3872 7.65166 9.59868 6.86317 8.62936 6.86317ZM9.59067 8.56233L9.41643 9.21235C9.38925 9.31334 9.31028 9.39231 9.2093 9.41947L8.55928 9.59371C8.4638 9.62004 8.35346 9.59504 8.27634 9.51789L7.80055 9.04211C7.72645 8.96801 7.69757 8.86016 7.72473 8.75916L7.89897 8.10914C7.92616 8.00815 8.00513 7.92918 8.1061 7.90201L8.75612 7.72778C8.85655 7.69973 8.96469 7.72949 9.03907 7.8036L9.51485 8.27938C9.58895 8.35348 9.61784 8.46133 9.59067 8.56233Z"
                fill="#FACC15"
              />
              <path
                d="M3.84234 2.5749C4.00398 1.9698 3.82945 1.31892 3.38715 0.876597C2.7231 0.212847 1.56467 0.212847 0.90121 0.876597C0.215995 1.5621 0.215995 2.67732 0.90121 3.36253C1.34152 3.80285 1.99355 3.97994 2.59951 3.81773L3.72998 4.96437L4.97299 3.7215L3.84234 2.5749ZM3.07615 2.0316L2.90191 2.68162C2.87473 2.78261 2.79576 2.86158 2.69478 2.88875L2.04476 3.06298C1.94928 3.08931 1.83894 3.06431 1.76182 2.98716L1.28603 2.51138C1.21193 2.43728 1.18305 2.32943 1.21021 2.22843L1.38445 1.57841C1.41164 1.47742 1.4906 1.39845 1.59158 1.37128L2.2416 1.19705C2.3426 1.16958 2.45045 1.19876 2.52455 1.27287L3.00033 1.74865C3.07443 1.82275 3.10332 1.9306 3.07615 2.0316Z"
                fill="#FACC15"
              />
            </svg>
            50%
